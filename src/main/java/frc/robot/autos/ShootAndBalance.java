...
public class ShootAndBalance extends SequentialCommandGroup {
    public ShootAndBalance(Swerve s_Swerve, ElevatorSubsystem s_Elevator, WristSubystem s_Wrist, BooleanSupplier isBox, IntakeSubsystem s_Intake){
        s_Swerve.zeroGyro();
       ...
       /*  PPSwerveControllerCommand swerveControllerCommand = //new PPSwerveControllerCommand(newExample, s_Swerve::getPose, new PIDController(Constants.AutoConstants.kPXController, 0, 0), new PIDController(Constants.AutoConstants.kPYController, 0, 0), null, null, null) ; 
        ...
        addCommands(
            new ElevatorAndWrist(s_Elevator, s_Wrist, isBox, 6).withTimeout(3.0),
            new DriveIntake(s_Intake, -0.76).withTimeout(0.5),
            new ElevatorAndWrist(s_Elevator, s_Wrist, isBox, 0).withTimeout(0.75),
            new DriveIntake(s_Intake, 0).withTimeout(0.25),
